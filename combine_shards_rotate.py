...
print("📄 Files ready:")
# =====================================================
# ADVANCE MONTHLY LOGGING (FUTURE-ONLY)
# =====================================================
ADV_LOG_ROOT = "advance/logs"
os.makedirs(ADV_LOG_ROOT, exist_ok=True)

# current month folder: advance/logs/2026-01
MONTH_FOLDER = os.path.join(ADV_LOG_ROOT, NOW_IST.strftime("%Y-%m"))
os.makedirs(MONTH_FOLDER, exist_ok=True)

# file inside folder: advance/logs/2026-01/monthlylogs.json
...
# resolve TARGET DATE (future)
TARGET_DATE = datetime.strptime(DATE_CODE, "%Y%m%d").strftime("%d/%m/%Y")

# build snapshot bucket = TIME + TODAY
TIME_KEY = NOW_IST.strftime("%I%p")               # e.g. 05PM
TODAY_KEY = NOW_IST.strftime("%d/%m")             # e.g. 12/01
BUCKET = f"{TIME_KEY}, {TODAY_KEY}"               # e.g. "05PM, 12/01"
...
for movie, d in movies_summary.items():
    ...
    # metric array SAME AS DAILY ORDER
